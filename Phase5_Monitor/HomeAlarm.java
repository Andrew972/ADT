...
public class HomeAlarm {
    ...
    public HomeAlarm(String a, String b, String c, String d, String e){
...
//        System.out.println(list_of_warning_status_location_updates.size());
    ...
    * */
    ...
    String simulation(String em){
        ...
        if(em.equals("Fire"))
        {
            this.list_of_smoke_sensors.get(0).setAlarmStatus(true);
        	emergency ="Fire";
        	this.list_of_smoke_sensors.get(0).setAlarmStatus(false);
        }
        else if(em.equals("Hosptial"))
        {
        	this.list_of_carbon_sensors.get(0).setAlarmStatus(true);
        	emergency = "Hospital";
        }
        else if(em.equals("Police"))
        {
            this.list_of_doorOrwindow_sensors.get(0).setAlarmStatus(true);
        	emergency = "Police";
        }
        return emergency;
    }
